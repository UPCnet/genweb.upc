(function ($) {
            ...
            case 'MultipleSelectionWidget':
                ...
                if (index == 'Subject') {
                    ...
                    var dl2 = $(document.createElement('dl'))
                        .addClass('querywidget radioWidget')
        ...
        items.each(function () {
            ...
            switch (widget) {
                ...
                case 'MultipleSelectionWidget':
                    ...
                    multipleselectionwidget.find('input[name=\"form.widgets.ICollection.query.v:records:list\"]:checked').each(function () {
                        querylist.push('query.v:records:list=' + $(this).val());
                    });
                    var logicaloperator = $('input[name=optradio]:checked').val();
                    querylist.push('query.k:records=' + logicaloperator);
                    break;
                default:
    ...
    $(document).ready(function () {
        ...
        $('#formfield-form-widgets-ICollectionCustom-logical_op').hide();
    });
    ...
    $.querywidget.init = function () {
        ...
        $("div.QueryWidget").on('change', '.radioWidget input', function () {
            var logicaloperator = $('input[name=optradio]:checked').val();
            $('#form-widgets-ICollectionCustom-logical_op').val(logicaloperator);
            $('#form-widgets-ICollection-logical_op').val(logicaloperator);
            $.querywidget.updateSearch();
        });
